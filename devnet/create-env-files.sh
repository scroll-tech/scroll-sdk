...
get_service_configmap_variables() {
    ...
    case "$service_name" in
        ...
        balance-checker)
            ...
            ;;
        blockscout)
            echo "L1_RPC_ENDPOINT:SCROLL_L1_RPC BLOCKSCOUT_DB_CONNECTION_STRING:DATABASE_URL L1_SCROLL_CHAIN_PROXY_ADDR:INDEXER_SCROLL_L1_CHAIN_CONTRACT L1_CONTRACT_DEPLOYMENT_BLOCK:INDEXER_SCROLL_L1_BATCH_START_BLOCK L1_SCROLL_MESSENGER_PROXY_ADDR:INDEXER_SCROLL_L1_MESSENGER_CONTRACT L1_CONTRACT_DEPLOYMENT_BLOCK:INDEXER_SCROLL_L1_MESSENGER_START_BLOCK L2_SCROLL_MESSENGER_PROXY_ADDR:INDEXER_SCROLL_L2_MESSENGER_CONTRACT L1_GAS_PRICE_ORACLE_ADDR:INDEXER_SCROLL_L2_GAS_ORACLE_CONTRACT"
            ;;
        bridge-history-api)
