...
get_service_configmap_variables() {
    ...
    case "$service_name" in
        ...
        bridge-history-fetcher)
            ...
            ;;
        chain-monitor)
            echo "L1_RPC_ENDPOINT:SCROLL_L1_RPC CHAIN_MONITOR_DB_CONNECTION_STRING:SCROLL_CHAIN_MONITOR_DB_CONFIG_DSN"
            ;;
        contracts)
        ...
        l1-explorer)
            ...
            ;;
        l2-bootnode)
            echo "CHAIN_ID_L2:CHAIN_ID L1_RPC_ENDPOINT:L2GETH_L1_ENDPOINT L2_GETH_STATIC_PEERS:L2GETH_PEER_LIST L1_CONTRACT_DEPLOYMENT_BLOCK:L2GETH_L1_CONTRACT_DEPLOYMENT_BLOCK L2GETH_CCC_NUMWORKERS:L2GETH_CCC_NUMWORKERS L2GETH_GLOBAL_QUEUE:L2GETH_GLOBAL_QUEUE L2GETH_ACCOUNT_QUEUE:L2GETH_ACCOUNT_QUEUE L2GETH_GLOBAL_SLOTS:L2GETH_GLOBAL_SLOTS L2GETH_ACCOUNT_SLOTS:L2GETH_ACCOUNT_SLOTS"
            ;;
        l2-rpc)
            echo "CHAIN_ID_L2:CHAIN_ID L1_RPC_ENDPOINT:L2GETH_L1_ENDPOINT L1_CONTRACT_DEPLOYMENT_BLOCK:L2GETH_L1_CONTRACT_DEPLOYMENT_BLOCK L2_GETH_STATIC_PEERS:L2GETH_PEER_LIST L2GETH_CCC_NUMWORKERS:L2GETH_CCC_NUMWORKERS L2GETH_GLOBAL_QUEUE:L2GETH_GLOBAL_QUEUE L2GETH_ACCOUNT_QUEUE:L2GETH_ACCOUNT_QUEUE L2GETH_GLOBAL_SLOTS:L2GETH_GLOBAL_SLOTS L2GETH_ACCOUNT_SLOTS:L2GETH_ACCOUNT_SLOTS"
            ;;
        l2-sequencer)
            echo "CHAIN_ID_L2:CHAIN_ID L1_RPC_ENDPOINT:L2GETH_L1_ENDPOINT L2GETH_SIGNER_ADDRESS:L2GETH_SIGNER_ADDRESS L1_CONTRACT_DEPLOYMENT_BLOCK:L2GETH_L1_CONTRACT_DEPLOYMENT_BLOCK L2GETH_KEYSTORE:L2GETH_KEYSTORE L2GETH_PASSWORD:L2GETH_PASSWORD L2GETH_NODEKEY:L2GETH_NODEKEY L2_GETH_STATIC_PEERS:L2GETH_PEER_LIST L2GETH_CCC_NUMWORKERS:L2GETH_CCC_NUMWORKERS L2GETH_GLOBAL_QUEUE:L2GETH_GLOBAL_QUEUE L2GETH_ACCOUNT_QUEUE:L2GETH_ACCOUNT_QUEUE L2GETH_GLOBAL_SLOTS:L2GETH_GLOBAL_SLOTS L2GETH_ACCOUNT_SLOTS:L2GETH_ACCOUNT_SLOTS"
            ;;
        rollup-node)
