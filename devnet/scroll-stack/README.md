...
scroll helm charts to deploy scroll's stack

**Homepage:** <https://github.com/scroll-tech/scroll-stack>
...
|------------|------|---------|
|  | balance-checker | 0.0.1 |
|  | blockscout | 0.0.1 |
|  | blockscout-sc-verifier | 0.0.1 |
|  | bridge-history-api | 0.0.1 |
|  | bridge-history-fetcher | 0.0.1 |
|  | chain-monitor | 0.0.1 |
|  | contracts | 0.0.1 |
...
| grafana.adminPassword | string | `"scroll-stack"` |  |
...
| kube-prometheus-stack.prometheus.enabled | string | `"yes"` |  |
